#ifndef TauAnalysis_CandidateTools_XNTFit_h
#define TauAnalysis_CandidateTools_XNTFit_h
#include <sstream>
#include <iostream>
#include "TFile.h"
...
class NTFit { 
 public:
  ...
  NTFit(int iType=1,std::string iLikelihoodFile="files/params.root",Options iOption=kHistLikelihood, CalcOptions iCalcOption=kMean,int iNEvents=500.,bool iCorrectMet=false);
  ~NTFit() { }
  ...
  TLorentzVector NeutrinoToy(TRandom2 &iRand,double &iX,double &iCosPhi,TLorentzVector &iTau,double iPt,double iPhi, double iEta,double iMLep,bool i3Body=true,double iXMin=0.);
  //Main Function
  ...
  //Books
  void fillPars(double iWeight, TLorentzVector &iSys,TLorentzVector &iTau1,TLorentzVector &iTau2);
  void divide();
  void maxPars (double iWeight, TLorentzVector &iSys,TLorentzVector &iTau1,TLorentzVector &iTau2);
